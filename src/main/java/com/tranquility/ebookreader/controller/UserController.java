...
import com.tranquility.ebookreader.service.CloudinaryService;
...
public class UserController {
    ...
    public ResponseEntity<?> updateProfilePicture(@RequestParam("file") MultipartFile profilePic) {
        try {
            byte[] bytes = cloudinaryService.resizeProfilePic(profilePic.getInputStream());
            String cloudUrl = cloudinaryService.uploadProfilePicToCloud(userService.getCurrentUserId(), profilePic.getContentType(), bytes);
