...
public class MLTaskController {
    ...
    public ResponseEntity<?> healthCheck() {
        String healthRes = pythonBackendService.healthCheck();
...
//        Not generated yet, generating now...
        try {
            ...
            try (InputStream is = gCloudService.downloadFile(info.getCloudUrl())) {
                ...
                String generatedSummary = pythonBackendService.generateSummary(chapter.getTexts()); // Generate Summary
...
//        Not generated yet, generating now...
        try {
            ...
            String generatedQuiz = pythonBackendService.generateQuiz(summaryContent); // Generate Quiz
